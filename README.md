...
4. Finally, create a new page (or use the example) that you'd like to be protected and place the beginning snippet at the top (above the `DOCTYPE` declaration) and the ending snippet at the bottom (below the closing `html` tag).
